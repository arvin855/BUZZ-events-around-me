			...
			<div class="app-content">
				...
				<!-- end: TOP NAVBAR -->
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15"><i class="fas fa-id-card fa-lg">  Manage Users</i></h5></b>
...
?>
								...
								<a href="edit-user.php?id=<?php echo $row['user_id'];?>" class="btn btn-transparent btn-xs"><i class="fas fa-pencil-alt fa-lg" style=""></i></a>					
