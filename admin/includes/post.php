...
echo  '<b><a class="profilelink" href="profile_samp.php?id=' . $row['user_id'] .'">'.' '.' '.  $row['fname'] . ' ' . $row['lname']. '</b></a>';
echo '<b><p style="float: right;"><span class="postedtime">' . $row['post_time'] . '</span>';
echo '</p></b>';
echo'</div>';
?>
<a style="float:right;" href="home.php?id=<?php echo $row['post_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips"><i style="color:red;" class="fas fa-trash-alt fa-lg"> Delete Post</i></a>
<br>
<?php
